...
int main() {
	...
	double eta0=0.1,eta,gamma=0.9,eps=0.5;//, eps0=0.5;
  // Agent 1 values
  int s, s0_1,s1_1,a,a0_1,a1_1=4,ar_1,u, tk, tk_1, tk_1_old;
	double rr_1;
  double ent_1, qq_1;
	double V_1[S],qn_1,qa_1[TK][S][A], qx_1[A];
	double mu_1[S];
  ...
  // Agent 2 values
#if MULTI
  int s0_2,s1_2,a0_2,a1_2=4,ar_2, tk_2, tk_2_old;
  double rr_2;
  double V_2[S],qn_2,qa_2[TK][S][A], qx_2[A];
  double mu_2[S];
...
////// Action Choices /////////////////////////////////
    // Agent 1
			...
			qn_1=-1.0e10;
			for (a=0;a<A;a++) {
				if (qa_1[tk_1][s1_1][a]>qn_1) {
					qn_1=qa_1[tk_1][s1_1][a];
    ...
    // Agent 2
      ...
      qn_2=-1.0e10;
      for (a=0;a<A;a++) {
        if (qa_2[tk_2][s1_2][a]>qn_2) {
          qn_2=qa_2[tk_2][s1_2][a];
...
////// Update Value Function /////////////////////////////////
    // Agent 1
			qa_1[tk_1_old][s0_1][a0_1]+=eta*(rr_1+gamma*V_1[s1_1]-qa_1[tk_1_old][s0_1][a0_1]);
			s0_1=s1_1;
      tk_1_old = tk_1;
#if MULTI
    // Agent 2
      qa_2[tk_2_old][s0_2][a0_2]+=eta*(rr_2+gamma*V_2[s1_2]-qa_2[tk_2_old][s0_2][a0_2]);
      s0_2=s1_2;
      tk_2_old = tk_2;
#endif
		}
