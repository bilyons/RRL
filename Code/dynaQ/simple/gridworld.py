...
class Gridworld(object):
    ...
    def __init__(self, grid_size, wind, discount, r_dif):
        """
        ...
        self.r_dif = r_dif
        self.features = self.feature_matrix()
    ...
    def reward(self, state_int):
        ...
        if state_int == self.n_states - 1:
            return 1
        if state_int == self.n_states - self.grid_size:
            return 1-self.r_dif
        return 0
        ...
        for _ in range(n_trajectories):
            ...
            for _ in range(trajectory_length):
                if rn.random() < self.wind:
                    ...
                    action = self.actions[np.random.choice(4, 1, p=policy(self.point_to_int((sx, sy))))[0]]
