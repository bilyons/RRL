...
def main():
	...
	# set-up mdp
	world, rewards, terminals = create_lw()
	...
	for run in range(runs):
		...
		reward_maxent = np.ones(world.state_space)
	...
	print("RRL within acceptable margin percentage: ", sum(rrl))
