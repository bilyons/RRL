...
def generate_trajectories(world, rewards, terminals):
...
def main():
    ...
    # set-up mdp
    world, reward, terminals = create_world()
    ...
    trajectories, expert_policy = generate_trajectories(world, reward, terminals)
